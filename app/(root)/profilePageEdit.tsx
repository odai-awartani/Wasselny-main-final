...
const ProfileEdit = () => {
  ...
  const phoneNumber =
    (user?.unsafeMetadata?.phoneNumber as string) || "+972342423423";
      ...
      if (field === "carType") {
        ...
        if (isNaN(seats) || seats < 1 || seats > 10) {
          setAlertConfig({
            ...
            message:
              language === "ar"
                ? "يرجى إدخال عدد مقاعد صالح (1-10)"
                : "Please enter a valid number of seats (1-10)",
            type: "error",
            onConfirm: () => setAlertConfig({ ...alertConfig, visible: false }),
            confirmText: language === "ar" ? "حسناً" : "OK",
            onCancel: undefined,
  ...
  const handleCarImagePick = async () => {
    try {
      ...
      if (!uploadedImageUrl) {
        throw new Error(
          language === "ar"
            ? "فشل في تحميل صورة السيارة"
            : "Failed to upload car image"
        );
      }
          ...
          return {
            ...
            data: {
              ...
              driver: {
                ...
                created_at:
                  prev.data.driver?.created_at || new Date().toISOString(),
              },
            },
          };
        });
      ...
      setAlertConfig({
        ...
        message:
          language === "ar"
            ? "حدث خطأ أثناء تحديث صورة السيارة"
            : "Failed to update car image",
        type: "error",
        onConfirm: () => setAlertConfig({ ...alertConfig, visible: false }),
        confirmText: language === "ar" ? "حسناً" : "OK",
        onCancel: undefined,
  ...
  const handlePhoneNumberUpdate = async () => {
    ...
    try {
      ...
      setAlertConfig({
        ...
        message:
          language === "ar"
            ? "حدث خطأ أثناء تحديث رقم الهاتف"
  ...
  const handleCarTypeUpdate = async () => {
    ...
    try {
      ...
      setAlertConfig({
        ...
        message:
          language === "ar"
            ? "حدث خطأ أثناء تحديث نوع السيارة"
            : "Failed to update car type",
        type: "error",
        onConfirm: () => setAlertConfig({ ...alertConfig, visible: false }),
        confirmText: language === "ar" ? "حسناً" : "OK",
        onCancel: undefined,
  ...
  const handleCarSeatsUpdate = async () => {
    ...
    try {
      ...
      setAlertConfig({
        ...
        message:
          language === "ar"
            ? "تم تحديث عدد المقاعد بنجاح"
            : "Car seats updated successfully",
        type: "success",
        onConfirm: () => {
          setAlertConfig({ ...alertConfig, visible: false });
      ...
      setAlertConfig({
        ...
        message:
          language === "ar"
            ? "حدث خطأ أثناء تحديث عدد المقاعد"
            : "Error updating car seats",
        type: "error",
        onConfirm: () => setAlertConfig({ ...alertConfig, visible: false }),
        confirmText: language === "ar" ? "حسناً" : "OK",
        onCancel: undefined,
    ...
    <>
      ...
      <SafeAreaView className="flex-1 bg-white">
        ...
        >
          {/* Profile Images */}
          <View
            className={`${userData.isDriver ? "flex-row justify-between" : "items-center"}`}
          >
          ...
          <View className="mt-6 space-y-6">
            ...
            <View>
              <Text
                className={`text-gray-500 text-[13px] mb-1 font-CairoRegular ${language === "ar" ? "text-right" : "text-left"}`}
              >
                {language === "ar" ? "الاسم الكامل" : "Full Name"}
              </Text>
              <View className="bg-white py-3 px-3 border border-gray-200 rounded-md">
                <Text
                  className={`text-[15px] text-gray-800 font-CairoMedium ${language === "ar" ? "text-right" : "text-left"}`}
                >
                  {user?.fullName ||
            ...
            {userData.isDriver && (
              <>
                ...
                <View>
                  <Text
                    className={`text-gray-500 text-[13px] mb-1 mt-4 font-CairoRegular ${language === "ar" ? "text-right" : "text-left"}`}
                  >
                    {language === "ar" ? "نوع السيارة" : "Car Type"}
                  </Text>
                  <View
                    className={`bg-white py-3 px-3 border border-gray-200 rounded-md flex-row justify-between items-center ${language === "ar" ? "flex-row-reverse" : ""}`}
                  >
                    <Text
                      className={`text-[15px] text-gray-800 font-CairoMedium ${language === "ar" ? "text-right" : "text-left"}`}
                    >
                ...
                <View>
                  ...
                  >
                    ...
                    <TouchableOpacity
                      onPress={() => setShowCarSeatsModal(true)}
                    >
                      <MaterialIcons name="edit" size={20} color="#F97316" />
                    </TouchableOpacity>
                  </View>
            ...
            >
              <View
                className={`w-9 h-9 rounded-full bg-orange-500 items-center justify-center ${language === "ar" ? "ml-3.5" : "mr-3.5"}`}
              >
                <MaterialIcons name="lock" size={22} color="#fff" />
              </View>
              <Text
                className={`text-base font-CairoBold text-gray-800 mt-2 ${language === "ar" ? "text-right" : "text-left"}`}
              >
        ...
        >
          <View className="flex-1 bg-black/50 justify-center items-center p-4">
            <View className="bg-white rounded-2xl w-full max-w-sm p-6">
              <Text
                className={`text-lg font-CairoBold mb-4 font-CairoMedium ${language === "ar" ? "text-right" : "text-left"}`}
              >
              ...
              <TextInput
                ...
                keyboardType={
                  editingField === "carSeats" ? "number-pad" : "phone-pad"
                }
            ...
            <View className="bg-white rounded-2xl w-full max-w-sm p-6">
              ...
              <View className="relative mb-4">
                <TextInput
                  ...
                  className={`bg-gray-50 rounded-xl p-4 font-CairoRegular ${language === "ar" ? "text-right" : "text-left"}`}
                  placeholder={
                    language === "ar"
                      ? "كلمة المرور الحالية"
                      : "Current Password"
                ...
                <TouchableOpacity
                  ...
                  className={`absolute ${language === "ar" ? "left-4" : "right-4"} top-4`}
                >
                  <MaterialIcons
        ...
        >
          <View className="flex-1 bg-black/50 justify-center items-center p-4">
            <View className="bg-white rounded-2xl w-full max-w-sm p-6">
              ...
              <View className="mb-4">
                <Text
                  className={`text-sm text-gray-500 mb-2 font-CairoRegular ${language === "ar" ? "text-right" : "text-left"}`}
                >
                  {language === "ar" ? "الرقم الحالي" : "Current Number"}
                </Text>
                <Text
                  className={`text-base text-gray-800 font-CairoMedium ${language === "ar" ? "text-right" : "text-left"}`}
                >
                  {phoneNumber}
                </Text>
              </View>
              ...
              <View className="mb-4">
                ...
                <View
                  className={`flex-row items-center bg-gray-50 rounded-xl overflow-hidden ${language === "ar" ? "flex-row-reverse" : ""}`}
                >
                  ...
                  <TextInput
                    ...
                    placeholder={
                      language === "ar" ? "أدخل الرقم" : "Enter number"
                    }
                ...
                <Text
                  className={`text-xs text-gray-500 mt-2 font-CairoRegular ${language === "ar" ? "text-right" : "text-left"}`}
                >
                  {language === "ar"
        ...
        >
          <View className="flex-1 bg-black/50 justify-center items-center p-4">
            <View className="bg-white rounded-2xl w-full max-w-sm p-6">
              ...
              <Text
                className={`text-xs text-gray-500 mb-4 font-CairoRegular ${language === "ar" ? "text-right" : "text-left"}`}
              >
                {language === "ar"
