...
export const translations: Translations = {
  ar: {
    ...
    cancel: "إلغاء",
    signUpHint: "يرجى ملء جميع الحقول للتسجيل.",
    enterPhone: "أدخل رقم الهاتف",
    enterEmail: "أدخل البريد الإلكتروني",
    enterPassword: "أدخل كلمة المرور",
    enterConfirmPassword: "أدخل تأكيد كلمة المرور",
    enterVerificationCode: "أدخل رمز التحقق",
    verifyEmailHint: "الرجاء التحقق من بريدك الإلكتروني للحصول على رمز التحقق.",
    navigateToHomeHint: "اضغط هنا للذهاب إلى الشاشة الرئيسية.",
    ...
    agreeToTermsAlert: "الرجاء الموافقة على الشروط والأحكام",
    ...
    cancelBookingConfirmation: "هل أنت متأكد من إلغاء حجز هذا الراكب؟",
    yes: "نعم",
    no: "لا",
    bookingCancelled: "تم إلغاء الحجز",
    bookingCancelledByDriver: "تم إلغاء حجزك من قبل السائق للرحلة من",
    ...
    confirmAcceptRequest: 'تأكيد قبول الطلب',
    acceptRequestFor: 'قبول طلب',
    confirmRejectRequest: 'تأكيد رفض الطلب',
    rejectRequestFor: 'رفض طلب',
    ...
    noCarImage: "لا توجد صورة للسيارة",
  ...
  en: {
    ...
    cancel: "Cancel",
    signUpHint: "Please fill out all fields to sign up.",
    enterPhone: "Enter phone number",
    enterEmail: "Enter email",
    enterPassword: "Enter password",
    enterConfirmPassword: "Enter confirm password",
    enterVerificationCode: "Enter verification code",
    verifyEmailHint: "Please check your email for the verification code.",
    navigateToHomeHint: "Tap here to go to the home screen.",
    loading: "Loading...",
    genders: ['Male', 'Female'],
    industries: [
      'Student',
    ...
    cancelBookingConfirmation: "Are you sure you want to cancel this passenger's booking?",
    yes: "Yes",
    no: "No",
    bookingCancelled: "Booking Cancelled",
    bookingCancelledByDriver: "Your booking has been cancelled by the driver for the ride from",
    ...
    confirmAcceptRequest: 'Confirm Accept Request',
    acceptRequestFor: 'Accept request for',
    confirmRejectRequest: 'Confirm Reject Request',
    rejectRequestFor: 'Reject request for',
    ...
    noCarImage: "No Car Image Available",
